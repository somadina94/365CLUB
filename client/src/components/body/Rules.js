    ...
    <section className={classes.rules}>
      ...
      <div className={classes.content}>
        ...
        <p>
          ...
          equivalent to 50 356gainfuldice credits. There are no withdrawal
          ...
          of changes in the future. You can only withdraw is your account passed
          out ID verification.
        </p>
      </div>
      <div className={classes.content}>
        ...
        <p>
          ...
          account and sibscribe to 365CLUB MEMBERSHIP.
        </p>
      </div>
      <div className={classes.content}>
